...
public class Brecho {
	...
	public static void main(String[] args) {
		...
		produtos.add(nProg); //inclusão do produto 1 na lista de produtos
		nProg = new ProdutoBean("CD00002","Prod 2 ...", "Bla Bla Bla",1100.0,"Bla Bla Bla");
		produtos.add(nProg); //inclusão do produto 2 na lista de produtos
		nProg = new ProdutoBean("CD00003","Prod 3 ...", "Bla Bla Bla",120.0,"Bla Bla Bla");
		produtos.add(nProg); //inclusão do produto 3 na lista de produtos
		nProg = new ProdutoBean("CD00004","Prod 4 ...", "Bla Bla Bla",1300.0,"Bla Bla Bla");
		produtos.add(nProg); //inclusão do produto 4 na lista de produtos
		nProg = new ProdutoBean("CD00005","Prod 5 ...", "Bla Bla Bla",9400.0,"Bla Bla Bla");
		produtos.add(nProg); //inclusão do produto 5 na lista de produtos
		nProg = new ProdutoBean("CD00006","Prod 6 ...", "Bla Bla Bla",1500.0,"Bla Bla Bla");
		produtos.add(nProg); //inclusão do produto 6 na lista de produtos
